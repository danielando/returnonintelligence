          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none">
              ...
              <blockquote className="border-l-4 border-[#fc3c3d] pl-4 italic mb-4">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <a
                    href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('"I think every user is going to be creating these agents, these flows, these systems and managing them in order to get their own work done and working on their behalf." - Abram Jackson\n\nListen to the full episode: https://returnonintelligence.com/episodes/copilot-agents-that-work-together')}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#4a5568] hover:text-[#fc3c3d] transition-colors"
                  >
              ...
              <blockquote className="border-l-4 border-[#fc3c3d] pl-4 italic mb-4">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <a
                    href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('"I don\'t think it\'s exclusively an IT department role... I think any motivated information worker is going to be able to create and manage whole fleets or swarms of agents working on their behalf." - Abram Jackson\n\nListen to the full episode: https://returnonintelligence.com/episodes/copilot-agents-that-work-together')}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#4a5568] hover:text-[#fc3c3d] transition-colors"
                  >
              ...
              <blockquote className="border-l-4 border-[#fc3c3d] pl-4 italic mb-4">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <a
                    href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('"I can see there\'s going to be job roles where people are just managing agents. That\'ll be a role in itself, just being skilled in managing an entire team of agents." - Daniel Anderson\n\nListen to the full episode: https://returnonintelligence.com/episodes/copilot-agents-that-work-together')}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#4a5568] hover:text-[#fc3c3d] transition-colors"
                  >
