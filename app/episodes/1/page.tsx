          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg max-w-none">
              ...
              <blockquote className="border-l-4 border-[#fc3c3d] pl-4 italic mb-4">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <a
                    href={`https://twitter.com/intent/tweet?text=${encodeURIComponent('"I encourage anybody to use multiple of these AI products. Try asking ChatGPT to summarize your most recent emails from your manager... Of course it doesn\'t do that - that\'s not its job." - Abram Jackson\n\nListen to the full episode: https://returnonintelligence.com/episodes/1')}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-[#4a5568] hover:text-[#fc3c3d] transition-colors"
                  >
